...
public class MoleculeToAtomsKataTest {
    ...
    public MoleculeToAtomsKataTest(List<String> atoms, List<Integer> nums, String formula, String name) {
    ...
    public void testMolecule() {
        ...
        assertEquals(String.format("Should parse %s: %s", name, formula), expected, MoleculeToAtomsKata.getAtoms(formula));
    }
